...
func TestUpdateRelativeLinks(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"rewrites-outside-link": {
			...
			expectedFileContent: "Hello world [inside](./README.md) [outside](https://github.com/khulnasoft/dummy/blob/main/README.md)\n",
		},
		"rewrites-outside-link-with-hashname": {
			...
			fileUnderTest:       "docs/README.md",
			expectedFileContent: "Hello world [inside](./README.md) [outside](https://github.com/khulnasoft/dummy/blob/main/README.md#somewhere)\n",
		},
	...
	for testName, test := range tests {
		t.Run(testName, func(t *testing.T) {
			...
			ctrl := controller{
				...
				logger:            logger,
				defaultBranch:     "main",
				repoURL:           "https://github.com/khulnasoft/dummy",
