...
`
	...
	tests := []struct {
	...
	}{
		{
			...
			input:    successOutput,
			instance: "dev",
			expected: "https://argo-workflows-dev.khulnasoft.net:443/workflows/argo/hello-world-4kx2g",
		},
		{
			name:     "output with name (ops)",
			input:    successOutput,
			instance: "ops",
			expected: "https://argo-workflows.khulnasoft.net:443/workflows/argo/hello-world-4kx2g",
		},
		{
