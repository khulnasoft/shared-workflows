...
- `validation_endpoint`: The endpoint to validate the configuration against. Defaults to `https://policy-bot.khulnasoft.net/api/v1/validate`.
  ...
  validate-policy-bot:
    ...
    steps:
      ...
      - name: Validate Policy Bot configuration
        uses: khulnasoft/shared-workflows/actions/validate-policy-bot-config@validate-policy-bot-config-v1.1.0
```
