...
> [!NOTE]
> If you are at Khulnasoft Labs, follow these steps in the [internal documentation](https://enghub.khulnasoft-ops.net/docs/default/component/deployment-tools/platform/continuous-integration/google-artifact-registry/) to set up a repository before using this action.
...
jobs:
  build-and-push:
    ...
    steps:
      ...
      - id: push-to-gar
        uses: khulnasoft/shared-workflows/actions/push-to-gar-docker@push-to-gar-docker-v0.3.1
        with:
